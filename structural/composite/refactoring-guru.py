...
class ComponentInterface:
    ...
    def get_parent(self) -> "ComponentInterface":
        return self._parent

    def set_parent(self, parent: "ComponentInterface"):
        """
    ...
    def add(self, component: "ComponentInterface") -> None:
        raise NotImplementedError()

    def remove(self, component: "ComponentInterface") -> None:
        raise NotImplementedError()
...
class Composite(ComponentInterface):
    ...
    def __init__(self) -> None:
        self._children: List[ComponentInterface] = []
...
def client_code(component: ComponentInterface) -> None:
    """
